...
interface SvapedApi {
    ...
    @GET("app/bike")
    @NotNull
    fun blockBike(@Query("requestType") paramInt: Int,
                  @Query("token") @NotNull paramString1: String,
                  @Query("bikeNumber") @NotNull paramString2: String): Observable<String>
    ...
    @GET("app/bike")
    @NotNull
    fun getBikesNearby(@Query("requestType") paramInt1: Int,
    ...
    @GET("app/city")
    @NotNull
    fun getClosestCity(@Query("requestType") paramInt: Int,
                       @Query("token") @NotNull paramString: String,
                       @Query("lat") paramDouble1: Double,
                       @Query("lng") paramDouble2: Double): Observable<CityDO>
    ...
    fun getRoute(
        ...
        @Query("key") @NotNull paramString5: String): Observable<String>
    ...
    fun setUserCity(
        @Query("requestType") paramInt: Int,
        @Query("token") @NotNull paramString: String,
        @Query("cityId") paramLong: Long): Completable
    ...
    fun subscribeBike(
        @Query("requestType") paramInt: Int,
        @Query("token") @NotNull paramString1: String,
        @Query("bikeId") @NotNull paramString2: String): Observable<String>

    @POST("app/bike")
    @NotNull
    fun unlockBike(@Query("requestType") paramInt: Int,
                   @Query("token") @NotNull paramString1: String,
    ...
    @POST("app/bike")
    @NotNull
    fun unsubscribeBike(@Query("requestType") paramInt: Int,
                        @Query("token") @NotNull paramString: String): Observable<String>

    @POST("app/bike")
    @NotNull
    fun updateBikeWay(@Query("requestType") paramInt: Int,
                      @Query("token") @NotNull paramString1: String,
                      @Query("bikeNumber") @NotNull paramString2: String,
                      @Query("lat") paramDouble1: Double,
                      @Query("lng") paramDouble2: Double
